        ...
        {!EmailSent ? (
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 focus:outline-none text-white font-medium rounded-lg py-2.5 px-5 flex items-center justify-center transition-all duration-200 ease-in-out"
            >
              {loading ? (
